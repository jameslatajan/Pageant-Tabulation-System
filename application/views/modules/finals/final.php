...
<div class="container-fluid">
    ...
    <div class="tab-pane fade show active" id="" role="tabpanel" aria-labelledby="prod-tab" tabindex="0">
        <div class="ms-5 me-5">
            <div class="row">
                <h2 class="mt-5 mb-4" style="text-align: center; font-weight:bold" class="text-uppercase">FINAL FIVE CONSOLIDATED RESULTS</h2>
                <div class="card">
                    <div class="card-body">
                        <?php if (!empty($record)) { ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php } else {?>
                                                <td></td>
                                            <?php }?>
                                            <th class="text-left" style=" padding-left: 15px;width:350px;"><img class="rounded-circle w-10" src="<?php echo $image_path . '/' . $rec['canNo'] ?>" alt=""><span style="padding-left: 20px;"> #<?php echo $rec['canNo'] ?> Bb. <?php echo $rec['fullname'] ?></span></th>
                                            <?php
                                            $total = 0;
                                            ...
                                            foreach ($rec['rating'] as $p) {
                                                $total += $p;
                                            ?>
                                                <th class="text-center" style="vertical-align:middle" style=""><?php if ($p) echo $p; ?></th>
