                                ...
                                <tr>
                                    <td style="width:240px">
                                        <ul style="padding-left: inherit; font-size: 11.5px !important">
                                            <li>POISE AND BEARING (15%)</li>
                                            <li>STAGE DEPORTMENT (35%)</li>
                                            <li>PERSONALITY AND CHARISMA (15%)</li>
                                            <li>FITNESS AND STYLE (35%)</li>
                                        </ul>
                                    </td>
                                    <td class="score-name text-center" style="width:175px">RATING:</td>
