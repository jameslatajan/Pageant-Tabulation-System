...
class ConsolidateFinal extends CI_Controller
{
    /**
    ...
    public function index()
    {
        ...
        $this->load->view('modules/consolidatefinal/show');
        $this->load->view('footer_config');
    }

    public function print_final_result(){
        ...
        $data = $this->data;    
         ...
         $html = $this->load->view('print/print_final_result', $data, true);
         $mpdf->WriteHTML($html);
         $mpdf->Output();
