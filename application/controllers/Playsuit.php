...
class Playsuit extends CI_Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        // start modifications
        $this->data['module_title']   = 'PLAYSUIT';
        $this->data['current_module'] = 'playsuit';

        $controller = 'playsuit/'; // modify the controller here
        ...
        $this->catTable               = 'miss_playsuit_rating';    //tables
        $this->module_path            = '/modules/playsuit/show';    //tables
        // end modifications
