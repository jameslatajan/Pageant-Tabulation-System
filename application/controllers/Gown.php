...
class Gown extends CI_Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        // start modifications
        $this->data['module_title']   = 'EVENING GOWN';
        $this->data['current_module'] = 'gown';

        $controller = 'gown/'; // modify the controller here
        ...
        $this->catTable               = 'miss_gown_rating';    //tables
        $this->module_path            = '/modules/gown/show';    //tables
        // end modifications
